...
var _finishConnecting = function(serverConfig, object, options, callback) {
  ...
  if(object.db_options.readPreference) {
    var readPreference = new ReadPreference(object.db_options.readPreference);
    // If we have the tags set up
    if(object.db_options.read_preference_tags)
      readPreference = new ReadPreference(object.db_options.readPreference, object.db_options.read_preference_tags);
